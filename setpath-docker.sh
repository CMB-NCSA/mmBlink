...
# For mac
export sptpath=/Users/felipe/SPT-3G/macos/
# For docker
export sptpath=/opt/spt

# For other software (e.g. Lyrebird) that needs to link to this
export SPT3G_SOFTWARE_PATH=${sptpath}/spt3g_software
export SPT3G_SOFTWARE_BUILD_PATH=${sptpath}/spt3g_software/build
